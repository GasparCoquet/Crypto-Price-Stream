...
**Frontend Dashboard**
- 📈 Interactive line charts showing live price movements
- 🔄 Auto-refresh: WebSocket every 5s, REST page every 60s
- 📊 Real-time price display with timestamp
- 🎨 Modern responsive UI built with Next.js and Chart.js
